...
class Adapter:
    ...
    def __init__(self, report_names):
        self.data_processor = eventProcessData.DataProcessor(os.getenv('BUCKET_NAME'))
    ...
    def process_data(self):
        ...
        for report_name in self.report_names:
            processor = eventDataTransfer.SalesforceProcessor(report_name, os.getenv('BUCKET_NAME'))  
